...
useSeoMeta({
  title: 'Why Choose LTHS | Lifetime Hospitality Services',
  description:
    'Discover why leading companies trust LTHS for their hospitality needs. Our expertise, reliability, and commitment set us apart.',
})
