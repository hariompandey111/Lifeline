...
useSeoMeta({
  title: 'Mission & Vision | LTHS - Lifetime Hospitality Services',
  description:
    'Discover the mission and vision that drive LTHS to deliver exceptional hospitality services every day.',
})
